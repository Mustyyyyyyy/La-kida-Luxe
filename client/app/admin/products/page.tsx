          ...
          <table className="min-w-[900px] w-full text-sm">
            ...
            <tbody>
              {loading ? (
                ...
                items.map((p) => (
                  <tr key={p._id} className="border-b border-white/10 align-top">
                    <td className="py-3 px-5">
                      <div className="flex items-center gap-3">
                        <div className="relative w-12 h-14 rounded-lg overflow-hidden border border-white/10 bg-black/20">
                          <Image
                    ...
                    <td className="py-3 px-5 text-right">
                      <div className="inline-flex gap-2">
                        <Link
                          ...
                          className="btn-outline px-3 py-2 text-[10px]"
                        >
                          Edit
                        </Link>
                        ...
                        <button
                          ...
                          className="border border-red-500/40 bg-red-500/15 text-white px-3 py-2 rounded-lg font-extrabold uppercase tracking-widest text-[10px] hover:bg-red-500/25 disabled:opacity-60"
                        >
