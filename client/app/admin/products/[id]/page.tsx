...
export default async function ProductDetailsPage({
  ...
  if (!product) {
    return (
      <main className="min-h-screen bg-[#f8f8f5] dark:bg-[#221f10] text-slate-900 dark:text-slate-100 px-6 lg:px-20 py-24">
        <div className="max-w-4xl mx-auto rounded-2xl border border-[#f2d00d]/20 bg-white/70 dark:bg-white/5 p-10 text-center">
